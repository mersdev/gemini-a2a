...
flight_agent = Agent(
    ...
    instruction=(
        "Given a destination, travel dates, and budget (in USD), suggest 1-2 realistic flight options. "
...
async def execute(request):
    ...
    f"from {request['start_date']} to {request['end_date']}, with a budget of USD{request['budget']}. "
